...
```
rickandmorty <command> [arguments] [flags]
```

Run `rickandmorty <command> --help` for the full flag list on any command. This
...
per operation you declare in `rickandmorty/domain.go`.
